...
class DataBaseSqlite():
    def __init__(self) -> None:
        caminho:str = os.path.dirname(os.path.realpath('~/'));
    ...
    def _connection(self) -> sqlite3.Connection:
        ...
        retornamos a mesma.
        """
        connection:sqlite3.Connection = sqlite3.connect(self.nome);
        return connection;
    ...
    # Auth
    # ----------------------- 
    def __user_existe(self,username:str) -> bool:
        """Checar user
    ...
    def __login_api(self,username:str,senha:str) -> bool:
        """Login api
        ...
        if(not self.__user_existe(username)):
            return retorno;
    ...
    def get_apiKey_user(self,username:str,senha:str)-> Union[str,None]:
        ...
        if(not self.__login_api(username,senha)):
            return retorno;
    ...
    def __checar_apiKey(self,apikey:str) -> bool:
        """Checar apiKey
    ...
    def __checar_privilegios(self,apikey:str) -> bool:
        """Checar privilégios
        ...
        if(self.__checar_apiKey(apikey)):
            return retorno;
    ...
    def __create_apiKey(self,tipo:Tipo_user) -> str:
        """Criação de apiKey
        ...
        while True:
            ...
            if(self.__checar_apiKey(apikey=apikey)):
                break
        ...
        if(retorno_select == []):
            return self.__create_apiKey(tipo);
    ...
    def create_user(self,username:str,senha:str,tipo:str,apikey:str) -> dict:
        ...
        if(not self.__checar_privilegios(apikey)):
            retorno['Erro'] = "User sem autorização";
            return retorno;
        if(self.__user_existe(username)):
            retorno['Erro'] = "User já existente";
            return retorno;
        
        id_apikey:str = self.__create_apiKey(
            tipo=tipo
        );
